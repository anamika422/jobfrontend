...
const Home = () => {
 ...
 const searchChanger = (e)=>{
  ...
  const getAllJobs = async()=>{
   try {
    let res = await axios.get('https://jobbackend-5yqy.onrender.com/job/getalljob')
    let data = res.data
  ...
  const handleJobSubmit = async()=>{
    ...
    let res = await axios.get(`https://jobbackend-5yqy.onrender.com/job/searchJob?location=${searchDetails.location}&title=${searchDetails.title}`)
    let data = res.data;
    console.log(data);
