  ...
  <div className="bg-black text-gray-100 text-[15px]">
    <div className="relative lg:min-h-screen 2xl:min-h-[730px] before:absolute before:inset-0 before:w-full before:bg-black before:opacity-60" style={{backgroundImage: 'url(https://readymadeui.com/dark-bg-image.webp)', backgroundSize: 'cover', backgroundRepeat: 'no-repeat'}}>
      ...
      {/* <div className="max-w-5xl mx-auto text-center relative px-4 sm:px-10 mt-16">
        <h1 className="lg:text-7xl md:text-6xl text-4xl font-semibold mb-6 md:!leading-[80px]">Build Landing Pages with
          Typeform
          Integration</h1>
        ...
        <div className="mt-14 flex gap-x-8 gap-y-4 justify-center max-sm:flex-col">
          <button type="button" className="px-6 py-3.5 rounded-md text-gray-100 bg-blue-700 hover:bg-blue-800 transition-all">Start a free
            trial</button>
          <button type="button" className="bg-transparent hover:bg-blue-600 border border-blue-600 px-6 py-3.5 rounded-md text-gray-100 transition-all">API
            documentation</button>
        </div>
      </div> */}
      <div>
      <div className="max-w-5xl mx-auto text-center relative px-4 sm:px-10 mt-16">
  <h1 className="lg:text-7xl md:text-6xl text-4xl font-semibold mb-6 md:!leading-[80px]">Find Your Dream Job or Hire Top Talent with Ease</h1>
  <p className="text-base text-gray-400">Browse through thousands of job listings, post your resume, or discover top talent for your business. The best career opportunities are just a click away. Start your journey today!</p>
  <div className="grid sm:grid-cols-3 gap-6 items-center mt-16">
    <div className="flex flex-col items-center text-center">
    ...
    <div className="flex flex-col items-center text-center">
      <h5 className="font-bold text-2xl text-blue-600 mb-2">1200+</h5>
      <p>Jobs Filled</p>
    </div>
    <div className="flex flex-col items-center text-center">
      <h5 className="font-bold text-2xl text-blue-600 mb-2">300+</h5>
      <p>Companies Hiring</p>
    </div>
  </div>
  <div className="mt-14 flex gap-x-8 gap-y-4 justify-center max-sm:flex-col">
    <Link to={'/signup'} type="button" className="px-6 py-3.5 rounded-md text-gray-100 bg-blue-700 hover:bg-blue-800 transition-all">Start Job Search</Link>
    <Link to={'/companysignup'} type="button" className="bg-transparent hover:bg-blue-600 border border-blue-600 px-6 py-3.5 rounded-md text-gray-100 transition-all">Post a Job</Link>
  </div>
</div>
    ...
    <div className="px-4 sm:px-10">
      <div className="mt-32 max-w-7xl mx-auto">
        <div className="mb-16 max-w-2xl text-center mx-auto">
          ...
          <p className="text-gray-400">Qui elit labore in nisi dolore tempor anim laboris ipsum ad ad consequat id. Dolore
        ...
        <div className="grid lg:grid-cols-3 md:grid-cols-2 gap-12 mt-16">
          <div className="text-center bg-[#111] px-6 py-8 rounded-2xl">
            ...
            <p className="text-gray-400">Customize our product to perfectly align with your brand and meet your unique
              requirements.</p>
          ...
          <div className="text-center bg-[#111] px-6 py-8 rounded-2xl">
            ...
            <p className="text-gray-400">Rest easy knowing that your data is safeguarded by the latest and most robust
          ...
          <div className="text-center bg-[#111] px-6 py-8 rounded-2xl">
            ...
            <p className="text-gray-400">Get prompt and reliable assistance with our 24/7 customer support for all your
      ...
      <div className="max-w-4xl mx-auto text-center mt-32">
        <div>
          <h2 className="md:text-4xl text-3xl font-semibold md:!leading-[50px] mb-6">Transform Your Ideas with our
            Comprehensive
            Template Library</h2>
          <p className="text-gray-400">Unlock creativity with our versatile templates designed to elevate your landing
        ...
        <button className="px-6 py-3.5 rounded-md text-gray-100 bg-blue-700 hover:bg-blue-800 transition-all mt-10">Get
          started
          today</button>
      </div>
      <div className="mt-32 rounded-md px-4 py-12">
        <div className="grid md:grid-cols-2 justify-center items-center gap-12 max-w-7xl mx-auto">
          ...
          <div className="max-md:text-center">
            <h2 className="md:text-4xl text-3xl font-semibold md:!leading-[50px] mb-6">Try using our templates with tailwind
              CSS
            </h2>
            <p className="text-gray-400">Veniam proident aute magna anim excepteur et ex consectetur velit ullamco veniam
      ...
      {/* <div className="mt-32 rounded-md px-4 py-12">
        <div className="grid md:grid-cols-2 justify-center items-center gap-12 max-w-7xl mx-auto">
          <div className="max-md:text-center">
            <h2 className="md:text-4xl text-3xl font-semibold md:!leading-[50px] mb-6">Elevate Your Experience with Modern
              Elegance</h2>
          ...
          <div>
            <img src="https://readymadeui.com/team-image.webp" alt="Premium Benefits" className="w-full mx-auto" />
          </div>
        </div>
      </div> */}
      <div className="mt-32 max-w-7xl mx-auto">
        <div className="mb-16 max-w-2xl text-center mx-auto">
          <h2 className="md:text-4xl text-3xl font-semibold md:!leading-[50px] mb-6">What our happy client say</h2>
          <p className="text-gray-400">Laboris qui Lorem ad tempor ut reprehenderit. Nostrud anim nulla officia ea sit
            deserunt. Eu eu quis anim aute Laboris qui Lorem ad tempor ut reprehenderit.</p>
        </div>
        <div className="grid md:grid-cols-3 gap-12 max-md:justify-center text-center mt-16">
          ...
          <div>
            <div className="flex flex-col items-center">
              <img src="https://readymadeui.com/profile_3.webp" className="w-24 h-24 rounded-full shadow-xl border-2 border-white" />
              <div className="mt-4">
          ...
          <div>
            <div className="flex flex-col items-center">
              <img src="https://readymadeui.com/profile_4.webp" className="w-24 h-24 rounded-full shadow-xl border-2 border-white" />
              <div className="mt-4">
      ...
      <div className="mt-32 max-w-7xl mx-auto">
        ...
        {/* <div className="grid lg:grid-cols-3 md:grid-cols-2 gap-8 mt-16 max-md:max-w-md max-md:mx-auto">
          <div className="hover:outline outline-blue-600 rounded relative overflow-hidden transition-all p-6">
            ...
            <button type="button" className="w-full px-6 py-3.5 rounded-md text-gray-100 bg-blue-700 hover:bg-blue-800 transition-all mt-10">Get
    ...
    <footer className="bg-[#111] px-4 sm:px-10 py-12 mt-32">
      <div className="lg:max-w-[50%] mx-auto text-center">
        ...
        <div className="bg-[#444] flex px-2 py-1 rounded-md text-left mt-10">
          ...
          <button type="button" className="px-6 py-3 rounded-md text-gray-100 bg-blue-700 hover:bg-blue-800 transition-all ml-auto">Submit</button>
        </div>
      </div>
